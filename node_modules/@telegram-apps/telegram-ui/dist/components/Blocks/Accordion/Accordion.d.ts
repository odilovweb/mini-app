...
export declare const Accordion: {
    ({ id, expanded, onChange, children, }: AccordionProps): JSX.Element;
    Summary: ({ after, before, onClick, children, ...restProps }: import("./components/AccordionSummary/AccordionSummary").AccordionSummaryProps) => JSX.Element;
    Content: ({ className, children, ...restProps }: import("./components/AccordionContent/AccordionContent").AccordionContentProps) => JSX.Element;
};
